...
const GeneratorPage: React.FC = () => {
  ...
  const documentTypes = [
    {
      ...
      description: 'Déposer une plainte pour un délit ou un crime',
      icon: FileText,
    },
    {
      id: 'pre-plainte',
      title: 'Pré-plainte en ligne',
      description: 'Démarche préalable avant dépôt de plainte',
      icon: FileText,
    },
    {
      id: 'main-courante',
      title: 'Main courante',
      description: 'Consigner des faits sans porter plainte',
      icon: FileText,
    },
    {
      id: 'recours-gracieux',
      title: 'Recours gracieux',
      description: 'Demande d\'annulation ou de modification d\'une décision',
      icon: FileText,
    },
  ];

  const steps = [
    { number: 1, title: 'Type de document', description: 'Choisissez le type de document à générer' },
    ...
    { number: 4, title: 'Détails juridiques', description: 'Précisez les aspects légaux' },
  ...
  const generateDocument = () => {
    ...
    console.log('Génération du document avec les données:', formData);
        ...
        <div className="flex justify-between">
          ...
          {currentStep < 5 ? (
            ...
            <div className="flex space-x-4">
              ...
              <Button onClick={generateDocument} className="flex items-center">
